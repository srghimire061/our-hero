...
namespace OurHeroWebAPI.Controllers
{
    ...
    [ApiController]
    public class OurHeroADOController : ControllerBase
    {
        private readonly IOurHeroServiceADO _heroService;
        public OurHeroADOController(IOurHeroServiceADO heroService)
        {
